$("#reviewExportBtn").on("click", function () {
  showInfoAlert(
    "Exporting Data",
    "Retrieving all review data for export...",
    "OK",
    exportReviewToExcel
  );
});
...
function exportReviewToExcel() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // ✅ Nếu không có data -> báo No Data Available và thoát
      if (!reviews || reviews.length === 0) {
        showTimedAlert("No Data Available", "No reviews available for export.", "warning", 1500);
        return;
      }

      // ✅ Có data -> export như cũ
