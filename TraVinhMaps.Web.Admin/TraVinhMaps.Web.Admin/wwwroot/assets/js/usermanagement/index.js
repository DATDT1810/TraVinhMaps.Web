$(document).ready(function () {
  ...
  $(document).on("click", ".ban-user", function (e) {
    ...
    showConfirmAlert("Confirmation", "Are you sure you want to ban this user?", "Ban", "Cancel")
      .then(ok => {
        if (!ok) return;
        $.ajax({
  ...
  $(document).on("click", ".unban-user", function (e) {
    ...
    showConfirmAlert("Confirmation", "Are you sure you want to unban this user?", "Unban", "Cancel")
      .then(ok => {
        if (!ok) return;
        $.ajax({
